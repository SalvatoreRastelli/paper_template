...
expander regime of Definition~\ref{def:expander},
...
indistinguishable, the means differing by $9.6\%$ on average with the sign of
the gap changing from size to size.
